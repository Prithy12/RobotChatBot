...
<body>
    ...
    <div class="download-section">
        ...
        <div class="download-buttons">
            <a href="https://github.com/YourUsername/claude-desktop/releases/download/v${version}/${windowsFileName}" class="download-button" id="windows-download" data-version="${version}">
                <img src="https://upload.wikimedia.org/wikipedia/commons/5/5f/Windows_logo_-_2012.svg" alt="Windows logo">
                Windows
            </a>
            <a href="https://github.com/YourUsername/claude-desktop/releases/download/v${version}/${macFileName}" class="download-button" id="mac-download" data-version="${version}">
                <img src="https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg" alt="Apple logo">
                macOS
            </a>
            <a href="https://github.com/YourUsername/claude-desktop/releases/download/v${version}/${linuxFileName}" class="download-button" id="linux-download" data-version="${version}">
